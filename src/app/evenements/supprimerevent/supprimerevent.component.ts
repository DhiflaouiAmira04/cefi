...
@Component({
  selector: 'app-supprimerevent',
  standalone: true,
  imports: [RouterModule,FormsModule ,CommonModule],
  templateUrl: './supprimerevent.component.html',
  styleUrl: './supprimerevent.component.css'
})
export class SupprimereventComponent implements OnInit {
