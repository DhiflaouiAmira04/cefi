...
@Component({
  ...
  styleUrl: './niveau1.component.css'
})
export class Niveau1Component implements OnInit {
...
groupedByDiplome: {
  ...
  apiUrl = 'http://localhost/CEFI/Dashborad/backend/emplois/get2.php';
  ...
  envoyerEmploi(diplome: any) {
    ...
    this.http.post(
      "http://localhost/CEFI/Dashborad/backend/emplois/envoyer_emploi2.php",
      formData
    ).subscribe({
      next: () => {
